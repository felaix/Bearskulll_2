...
public class SyncroIntro : MonoBehaviour
{
    ...
    IEnumerator PlayIntroEnglish()
    {
        ...
        AS.PlayOneShot(_introClipsEnglish[6], 1.2f  );
        yield return new WaitForSeconds(5.5f);
        AS.PlayOneShot(_introClipsEnglish[7], 1.2f  );
        yield return new WaitForSeconds(6.3f);
        AS.PlayOneShot(_introClipsEnglish[8], 1.2f  );
        yield return new WaitForSeconds(7.3f);
        AS.PlayOneShot(_introClipsEnglish[9], 1.2f  );
        yield return new WaitForSeconds(4.5f);
        AS.PlayOneShot(_introClipsEnglish[10], 1.2f  );
        yield return new WaitForSeconds(4.6f);
        AS.PlayOneShot(_introClipsEnglish[11], 2.9f  );
    ...
    IEnumerator PlayIntroGerman()
    {
        ...
        yield return new WaitForSeconds(5.3f);
        AS.PlayOneShot(_introClipsGerman[6], 1.2f  );
        yield return new WaitForSeconds(5.3f);
        AS.PlayOneShot(_introClipsGerman[7], 1.2f  );
        yield return new WaitForSeconds(6.3f);
        AS.PlayOneShot(_introClipsGerman[8], 1.2f  );
        yield return new WaitForSeconds(7.3f);
        AS.PlayOneShot(_introClipsGerman[9], 1.2f  );
        yield return new WaitForSeconds(4.5f);
        AS.PlayOneShot(_introClipsGerman[10], 1.2f  );
        yield return new WaitForSeconds(4.6f);
        AS.PlayOneShot(_introClipsGerman[11], 1.4f  );
